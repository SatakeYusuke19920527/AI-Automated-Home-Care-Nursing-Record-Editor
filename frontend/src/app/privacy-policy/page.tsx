...
export const metadata: Metadata = {
  title: 'プライバシーポリシー | Recoding App',
  description:
    'Recoding Appのプライバシーポリシー。個人情報の取り扱い方針やお問い合わせ窓口について記載しています。',
  openGraph: {
    title: 'プライバシーポリシー | Recoding App',
    description:
      'Recoding Appのプライバシーポリシー。個人情報の取り扱い方針やお問い合わせ窓口について記載しています。',
...
const sections = [
  {
    title: '1. 適用範囲',
    body: '本ポリシーは、Recoding AppのWebアプリケーション、API、サポート窓口を通じて取得した全ての利用者情報に適用されます。',
  },
  {
    title: '2. 取得する情報',
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 lg:py-24">
        <header className="space-y-3">
          ...
          <p className="text-base text-slate-600 dark:text-slate-300">
            Recoding
            App（以下「当サービス」）は、G検定対策を安心して行っていただけるよう、以下の方針に基づき利用者情報を取り扱います。
          </p>
        </header>
